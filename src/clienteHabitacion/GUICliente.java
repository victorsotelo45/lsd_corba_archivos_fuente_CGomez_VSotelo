...
public class GUICliente extends javax.swing.JFrame implements Runnable{
    ...
    private static GestionAsintomaticosInt objetoRefServidorAlertas;
        ...
        }else
        {
            ...
            try
            {
               ...
               // obtiene la referencia del rootpoa & activate el POAManager
                ...
                if(objetoRefServidorAlertas.registrarAsintomatico(asintomaticoCllbck) ){
                    JOptionPane.showMessageDialog(null, "Se registro paciente exitosamente!!!");
                    pacientes.put(Integer.parseInt(jTextFieldId.getText()), asintomaticoCllbck);
    ...
    private void jButtonBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonBuscarActionPerformed
        ...
        {    
            ...
            if(pacienteAsintomatico != null)
            {
                ...
                jTextAreaConsultas.append("Apellidos: "+pacienteAsintomatico.apellidos+"\n");
                jTextAreaConsultas.append("Tipo de Id: "+pacienteAsintomatico.tipo_id+"\n");
                jTextAreaConsultas.append("Id: "+pacienteAsintomatico.id+"\n");
                jTextAreaConsultas.append("Direccion: "+pacienteAsintomatico.direccion+"\n");
    ...
    private void jButtonDetenerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDetenerActionPerformed
        // TODO add your handling code here:
        if(!jTextFieldIdIndicador.getText().equals("")){
    ...
    public static void main(String args[]){
        try
        {
            ...
            objetoRefServidorAlertas = GestionAsintomaticosIntHelper.narrow(ncRef.resolve_str(name));
            System.out.println("Obtenido el manejador sobre el servidor deobjetos: " +objetoRefServidorAlertas);
                ...
                if(pacientes.containsKey(id)){
                    ...
                    while (procesos.get(id)) {
                        ...
                        try {
                            ...
                            appendToPane(jTextPaneArea, "Paciente: "+pacienteAsintomatico.nombres+" "+pacienteAsintomatico.apellidos+"\n", Color.blue);
                            appendToPane(jTextPaneArea, pacienteAsintomatico.tipo_id+": "+pacienteAsintomatico.id+"\n", Color.blue);
                            ...
                            objetoRefServidorAlertas.enviarIndicadores(id, fCardiaca, fRespiratoria, ToC);
                    ...
                    appendToPane(jTextPaneArea, "Ha finalizado el proceso enviar indicadores para el paciente "+pacienteAsintomatico.tipo_id+": "+pacienteAsintomatico.id+" "+pacienteAsintomatico.nombres+" "+pacienteAsintomatico.apellidos+"\n", Color.GREEN);
                }else{
